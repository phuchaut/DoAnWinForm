...
{
    public partial class frmProfileThuNgan : Form
    {
        NHANVIEN_DTO nvDTO= new NHANVIEN_DTO();
        private string maNV;
        private bool btnVisible = false;
        public frmProfileThuNgan(string maNV)
        {
            InitializeComponent();
            this.maNV = maNV;
        }
        ...
        private void frmProfileThuNgan_Load(object sender, EventArgs e)
        {
        ...
        private void btnCapNhat_Click(object sender, EventArgs e)
        {
            ...
            if (dr == DialogResult.Yes)
            {
                ...
                if (nvBUS.CapNhatThongTinProfile(nvQL))
                {
                    ...
                    frmProfileThuNgan_Load(sender, e);
                }
                else
                {
