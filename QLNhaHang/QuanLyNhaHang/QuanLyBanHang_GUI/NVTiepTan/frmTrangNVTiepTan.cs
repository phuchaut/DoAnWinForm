...
{
    public partial class frmTrangNVTiepTan : Form
    {
        Thread th;
        ...
        public frmTrangNVTiepTan(string loaiNV, string maNV)
        {
            InitializeComponent();
        ...
        private void btnTaiKhoan_Click(object sender, EventArgs e)
        {
            ...
            OpenForm(new frmProfileNVTiepTan(maNV), "Trang Thông Tin Tài Khoản");
        }

        private void btnQLHoaDon_Click(object sender, EventArgs e)
        {
            ActivateButton(sender, RGBColors.color1);
            OpenForm(new frmHoaDonThuNgan(loaiNV, maNV), "Trang Thông Tin Hóa Đơn");
        }
        ...
        private void frmTrangNVTiepTan_Load(object sender, EventArgs e)
        {
            ...
            OpenForm(new frmProfileNVTiepTan(this.maNV), "Trang Thông Tin Tài Khoản");
        }
