...
{
    public partial class frmProfileBep : Form
    {
        NHANVIEN_DTO nvDTO = new NHANVIEN_DTO();
        private string maNV;
        private bool btnVisible = false;
        public frmProfileBep(string maNV)
        {
            InitializeComponent();
            this.maNV = maNV;
        }
